...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, _______,   KC_LALT, LOWER,   KC_LGUI,  KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_MUTE, KC_VOLU, KC_VOLD, _______, KC_LGUI, KC_SPC, _______, _______, _______, _______, _______, _______
),
